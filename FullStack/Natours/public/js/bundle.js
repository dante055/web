...
var cutomConfirmPassValidator = function cutomConfirmPassValidator(confirmPassword, password) {
...
if (signUpForm) {
  ...
  cutomConfirmPassValidator(confirmPassword, _password);
  signUpForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _auth.signup)(fullName.value, _email.value, _password.value, confirmPassword.value);
  });
} // ------------ log out ---------
