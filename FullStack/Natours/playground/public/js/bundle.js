...
var signup = function signup(fullname, email, password, confirmPassword) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.axiosInstance.post('/users/login', {
              email: email,
              password: password
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.axiosInstance.get('/users/log-out');
...
},{"./axios":"axios.js","./alert":"alert.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(tourLocation) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFudGUwNTUiLCJhIjoiY2tpY3oxNW0wMGp1YTJwcnMzM3Rla3d3NyJ9.U5ujR9pKn5rwRTdAXV5jsQ';
  ...
  var sanitizedTourLocations = [];
  tourLocation.forEach(function (loc) {
    bounds.extend(loc.coordinates);
    sanitizedTourLocations.push({
      type: 'Feature',
      properties: {
        description: "<p><b>".concat(loc.description, "</b> (Day ").concat(loc.day, ")</p>")
      },
      geometry: {
        type: loc.type,
  ...
  map.on('load', function () {
    map.loadImage('/img/pin.png', // Add an image to use as a custom marker
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/users/updateUserPassword' : '/users/currentUser';
            _context.next = 4;
            return _axios.axiosInstance.patch(url, data);
...
},{"./axios":"axios.js","./alert":"alert.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var STRIPE_PUBLISHABLE_KEY = 'pk_test_t0Z138PqdQQMgTyOqGbbXYbG';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.axiosInstance.get("/bookings/checkout-session/".concat(tourId));
...
},{"./axios":"axios.js","./alert":"alert.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (mapbox) {
  var tourLocation = JSON.parse(mapbox.dataset.locations);
  (0, _mapbox.displayMap)(tourLocation);
} // ---------- logn in ------------
...
if (signUpForm || userPasswordForm) {
  ...
  confirmPassword.addEventListener('input', function (event) {
    if (_password.value !== confirmPassword.value) {
      confirmPassword.setCustomValidity("Password and confirm password don't match.");
    } else {
      confirmPassword.setCustomValidity('');
    }
  });
...
if (signUpForm) {
  ...
  var _password2 = document.querySelector('#password');

  var _confirmPassword = document.querySelector('#password-confirm');

  _confirmPassword.addEventListener('input', function (event) {
    if (_password2.value !== _confirmPassword.value) {
      _confirmPassword.setCustomValidity("Password and confirm password don't match.");
    } else {
      _confirmPassword.setCustomValidity('');
    }
  });

  signUpForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _auth.signup)(fullName.value, _email.value, _password2.value, _confirmPassword.value);
  });
} // ------------ log out ---------
...
if (userDataForm) {
  ...
  var _email2 = document.querySelector('#email');
  ...
  userDataForm.addEventListener('submit', function (e) {
    ...
    formData.append('email', _email2.value);
    formData.append('photo', photo.files[0]);
    (0, _updateSettings.updateSettings)(formData, 'data'); // updateSettings({ name: name.value, email: email.value }, 'data');
  });
}

if (userPasswordForm) {
  var passSaveBtn = document.querySelector('#btn--save-password');
  var currentPassword = document.querySelector('#password-current');
