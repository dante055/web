...
//  --------- Instance method ---------------------------
// to compare the login password with password stored in db
userSchema.methods.correctPassword = async function (candidatePassword) {
  return await bcrypt.compare(candidatePassword, this.password);
};

//  ---------- Instance method ---------------------------
// check if user have changed password (Expire the token if password habe been changed)
...
// ----------- Instance method ----------------------------
// check if user have logged out (Expire the token if he has logged out)
...
// ----------- Instance method -----------------------------
// To create the reset password token
